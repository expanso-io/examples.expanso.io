...
uniqueTasks: [review-content-routing-step-1-route-by-severity]
claimIds: []
...
4.  **Inspect:** Check the configured outputs and record which destinations accepted each synthetic event.

...
uniqueTasks: [review-content-splitting-complete-content-splitting]
claimIds: []
...
<CodeBlock language="yaml" title="content-splitting.yaml">
  {pipelineYaml}
</CodeBlock>
...
- [Troubleshooting](/data-routing/content-splitting/troubleshooting) - Common issues and solutions
- [Fan-Out Pattern](/data-routing/fan-out-pattern) - Send to multiple destinations

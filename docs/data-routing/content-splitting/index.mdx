...
### [Interactive Explorer](/data-routing/content-splitting/explorer)
See each splitting technique with side-by-side before/after views

### [Step-by-Step Tutorial](/data-routing/content-splitting/setup)
Build the pipeline incrementally:
1. [Split JSON Arrays](/data-routing/content-splitting/step-1-split-json-arrays)
2. [Split CSV Batches](/data-routing/content-splitting/step-2-split-csv-batches)
3. [Split Nested Structures](/data-routing/content-splitting/step-3-split-nested-structures)
4. [Advanced Patterns](/data-routing/content-splitting/step-4-advanced-patterns)
5. [Production Considerations](/data-routing/content-splitting/step-5-production-considerations)

### [Complete Pipeline](/data-routing/content-splitting/complete-content-splitting)

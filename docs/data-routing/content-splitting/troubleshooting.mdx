...
uniqueTasks: [review-content-splitting-troubleshooting]
claimIds: []
...
2. Check the [Complete Pipeline](/data-routing/content-splitting/complete-content-splitting) for reference config
3. Review [Fan-Out Pattern](/data-routing/fan-out-pattern) for multi-destination routing

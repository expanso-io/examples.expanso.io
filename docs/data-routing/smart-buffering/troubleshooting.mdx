...
uniqueTasks: [review-smart-buffering-troubleshooting]
claimIds: []
...
**Cause:** Classification repeatedly falls to the default case
...
2. Check the [Complete Pipeline](/data-routing/smart-buffering/complete-smart-buffering) for reference config
3. Review [Priority Queues](/data-routing/priority-queues) for separate queue routing

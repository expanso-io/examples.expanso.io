...
uniqueTasks: [review-priority-queues-step-4-prevent-starvation]
claimIds: []
...
The example now includes an age-based adjustment. Measure real scheduling and eventual-processing behavior in the destination queue and worker system.

...
### [Interactive Explorer](/data-routing/priority-queues/explorer)
See each priority routing technique with side-by-side before/after views

### [Step-by-Step Tutorial](/data-routing/priority-queues/setup)
Build the pipeline incrementally:
1. [Severity-Based Queues](/data-routing/priority-queues/step-1-severity-routing)
2. [Customer Tier Queues](/data-routing/priority-queues/step-2-customer-tier-routing)
3. [Multi-Criteria Scoring](/data-routing/priority-queues/step-3-multi-criteria-scoring)
4. [Prevent Starvation](/data-routing/priority-queues/step-4-prevent-starvation)

### [Complete Pipeline](/data-routing/priority-queues/complete-priority-pipeline)

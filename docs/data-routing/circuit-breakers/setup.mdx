...
- **Kafka:** Set up [Kafka](/getting-started/local-development#kafka) for message routing
- **PostgreSQL:** Set up [PostgreSQL](/getting-started/local-development#postgresql) for database circuit breaker testing

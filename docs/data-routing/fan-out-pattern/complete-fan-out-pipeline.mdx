...
uniqueTasks: [review-fan-out-pattern-complete-fan-out-pipeline]
claimIds: []
...
<CodeBlock language="yaml" title="fan-out-pattern.yaml">
  {pipelineYaml}
</CodeBlock>
...
- [Troubleshooting](/data-routing/fan-out-pattern/troubleshooting) - Common issues and solutions
- [Content Splitting](/data-routing/content-splitting) - Split arrays into individual messages

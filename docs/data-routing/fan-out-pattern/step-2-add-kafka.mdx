...
uniqueTasks: [review-fan-out-pattern-step-2-add-kafka]
claimIds: []
...
You will modify your `fan-out.yaml` file to send messages to both a local file _and_ a Kafka topic concurrently.

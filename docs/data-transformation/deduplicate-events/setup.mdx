...
- **Kafka:** Set up [Kafka](/getting-started/local-development#kafka) for data delivery
- **Redis:** Set up [Redis](/getting-started/local-development#redis) for deduplication cache

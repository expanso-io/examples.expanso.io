...
uniqueTasks: [inspect-transform-formats-troubleshooting]
claimIds: []
...
2. Check the [Complete Pipeline](/data-transformation/transform-formats/complete-pipeline) for reference config
3. Review [Aggregate Time Windows](/data-transformation/aggregate-time-windows) for batch processing

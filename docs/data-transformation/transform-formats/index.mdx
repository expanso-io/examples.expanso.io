...
### [Interactive Explorer](/data-transformation/transform-formats/explorer)
See format transformations with live before/after examples

### [Step-by-Step Tutorial](/data-transformation/transform-formats/setup)
Build the pipeline incrementally:
1. [JSON to Avro](/data-transformation/transform-formats/step-1-convert-json-avro)
2. [Avro to Parquet](/data-transformation/transform-formats/step-2-convert-avro-parquet)
3. [JSON to Protobuf](/data-transformation/transform-formats/step-3-convert-json-protobuf)
4. [Multi-Format Detection](/data-transformation/transform-formats/step-4-auto-detect-formats)

### [Complete Pipeline](/data-transformation/transform-formats/complete-pipeline)

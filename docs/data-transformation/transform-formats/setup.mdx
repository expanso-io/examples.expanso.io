...
keywords:
  [setup, environment, schema-registry, avro, parquet, protobuf, configuration]
contentArchetype: reference
executionStatus: architecture-only
operationalEvidence: not-assessed
localNavigation: true
uniqueTasks: [inspect-transform-formats-setup]
claimIds: []
...
1. **[Step 1: JSON to Avro](/data-transformation/transform-formats/step-1-convert-json-avro)**
2. **[Step 2: Avro to Parquet](/data-transformation/transform-formats/step-2-convert-avro-parquet)**
3. **[Step 3: JSON to Protobuf](/data-transformation/transform-formats/step-3-convert-json-protobuf)**
4. **[Step 4: Auto-Detection](/data-transformation/transform-formats/step-4-auto-detect-formats)**

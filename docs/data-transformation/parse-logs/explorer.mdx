...
- [**Step 1: Parse JSON Logs**](/data-transformation/parse-logs/step-1-parse-json-logs) - Application log processing with validation
- [**Step 2: Parse CSV Data**](/data-transformation/parse-logs/step-2-parse-csv-data) - Sensor data with type conversion
- [**Step 3: Parse Syslog Messages**](/data-transformation/parse-logs/step-3-parse-syslog-messages) - System event processing
- [**Step 4: Multi-Format Detection**](/data-transformation/parse-logs/step-4-multi-format-detection) - Unified pipeline architecture
- [**Step 5: Advanced Patterns**](/data-transformation/parse-logs/step-5-advanced-patterns) - Error handling and enrichment patterns

---

**Next:** [Set up your environment](/data-transformation/parse-logs/setup) to build this parser yourself

...
uniqueTasks: [inspect-parse-logs-troubleshooting]
claimIds: []
...
2. Check the [Complete Pipeline](/data-transformation/parse-logs/complete-parser) for reference config
3. Review [Transform Formats](/data-transformation/transform-formats) for format conversion

...
uniqueTasks: [inspect-parse-logs-complete-parser]
claimIds: []
...
<CodeBlock language="yaml" title="parse-logs.yaml">
  {pipelineYaml}
</CodeBlock>
...
- [Troubleshooting](/data-transformation/parse-logs/troubleshooting) - Common issues and solutions
- [Transform Formats](/data-transformation/transform-formats) - Convert between data formats

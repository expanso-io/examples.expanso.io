...
keywords:
  [advanced-aggregation, trend-analysis, multi-level, production, optimization]
contentArchetype: step
executionStatus: architecture-only
operationalEvidence: not-assessed
localNavigation: true
uniqueTasks: [inspect-aggregate-time-windows-step-4-advanced-patterns]
claimIds: []
...
Once you have mastered the three basic window types, you can combine them and add more sophisticated analytics logic.

...
uniqueTasks: [inspect-aggregate-time-windows-troubleshooting]
claimIds: []
...
2. Check the [Complete Pipeline](/data-transformation/aggregate-time-windows/complete-aggregation-pipeline) for reference config
3. Review [Deduplicate Events](/data-transformation/deduplicate-events) for handling duplicates

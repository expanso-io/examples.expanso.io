...
uniqueTasks: [inspect-normalize-timestamps-troubleshooting]
claimIds: []
...
2. Check the [Complete Pipeline](/data-transformation/normalize-timestamps/complete-pipeline) for reference config
3. Review [Parse Logs](/data-transformation/parse-logs) for format detection patterns

...
uniqueTasks: [inspect-normalize-timestamps-step-4-advanced-patterns]
claimIds: []
...
These patterns show additional authored time-series fields. Validate their semantics and downstream tradeoffs with representative queries before adopting them.

...
2. **Contact Expanso** — [expanso.io/contact](https://expanso.io/contact/) for help from the Expanso team
3. **GitHub organization** — [github.com/expanso-io](https://github.com/expanso-io) for public repos and issue trackers
4. **Pipeline validation** — always run `expanso pipeline validate your-pipeline.yaml` before deploying

---

→ **Back to:** [Complete SCADA Integration](/integrations/scada-energy-edge/complete-scada-integration)

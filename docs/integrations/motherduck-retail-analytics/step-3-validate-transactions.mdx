---
title: 'Step 3: Validate and Flag Transactions'
sidebar_label: 'Step 3: Validate'
sidebar_position: 5
description: 'Apply example validation rules and attach anomaly flags without dropping records.'
keywords: [retail, pos, validation, anomalies, data-quality]
...
uniqueTasks:
  [
    inspect-integrations-motherduck-retail-analytics-step-3-validate-transactions,
  ]
claimIds: []
...
- **Rule-based flags**: Measure precision and recall against labeled data before relying on these illustrative rules
...
→ [Step 4: Batch and Encode to Parquet](/integrations/motherduck-retail-analytics/step-4-batch-parquet-encode)

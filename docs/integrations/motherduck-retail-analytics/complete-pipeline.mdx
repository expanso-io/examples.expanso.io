---
title: "Complete MotherDuck Retail Analytics Pipeline"
sidebar_label: "Complete Pipeline"
sidebar_position: 9
description: "Review the complete example pipeline from synthetic POS events to partitioned Parquet on S3."
keywords: [motherduck, ducklake, retail, pos, parquet, s3, complete-pipeline]
---
...
The combined reference pipeline — from synthetic POS transactions to Parquet on S3.
...
## Illustrative Configuration and Required Measurements

| Metric | Value |
|--------|-------|
| Input rate | Synthetic generator setting; choose and record a test rate |
| Daily volume | Measure during the test window |
| Raw JSON size | Measure from generated input |
| Parquet output | Measure with the selected schema and codec |
| Batch size | 1000 rows or 10s window |
| File size | Measure from generated output |
| Data freshness | Measure end to end in the test environment |

---
title: 'Step 1: Collect O-RAN Metrics'
sidebar_label: 'Step 1: Collect Metrics'
sidebar_position: 4
description: 'Collect sample DU telemetry through file-based or API-based inputs.'
keywords: [oran, telecom, telemetry, collection, distributed-unit]
contentArchetype: step
executionStatus: architecture-only
operationalEvidence: not-assessed
localNavigation: true
uniqueTasks:
  [inspect-integrations-oran-telco-pipeline-step-1-collect-oran-metrics]
claimIds: []
...
| ------------------- | ----------------------------------------- | ---------------- | ---------------------------------------- |
| **PTP Timing**      | Authored timing offset                    | Fixture cadence  | Timing review                            |
| **Resource Blocks** | Physical Resource Block (PRB) utilization | 1Hz              | Capacity planning, congestion detection  |
| **System Metrics**  | CPU, memory, interface utilization        | Fixture cadence  | Operations review                        |
...
With O-RAN metrics flowing into your pipeline, proceed to [transform and enrich the data](/integrations/oran-telco-pipeline/step-2-transform-and-enrich.mdx) with Bloblang processing.

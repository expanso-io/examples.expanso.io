...
With Parquet storage and Cloudera integration configured, proceed to the [complete pipeline configuration](/integrations/oran-telco-pipeline/complete-oran-pipeline.mdx) to see the full production-ready YAML.
...
With Grafana dashboards providing real-time visibility, proceed to [Parquet storage and Cloudera integration](/integrations/oran-telco-pipeline/step-5-parquet-and-cloudera.mdx) for long-term analytics capabilities.

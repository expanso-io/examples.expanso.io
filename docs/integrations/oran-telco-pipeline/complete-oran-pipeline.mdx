---
title: "Complete O-RAN Telemetry Pipeline"
sidebar_label: "Complete Pipeline"
sidebar_position: 9
description: "Review the complete illustrative O-RAN telemetry configuration used by this walkthrough."
keywords: [oran, telecom, telemetry, complete-pipeline, edge-processing]
---
...
The combined illustrative configuration for data collection, transformation, and multi-destination routing.

<CopyPipelineButton yamlUrl="/pipelines/oran-telco-pipeline.yaml" />

## Full Pipeline YAML

```yaml
# Complete O-RAN Edge Telemetry Pipeline
# complete example configuration for OpenShift SNO deployment
...
This configuration is an architecture reference. Validate component versions, schemas, resource requests, security context, delivery behavior, and support status before attempting an OpenShift SNO deployment alongside RAN workloads.

---
title: "Setup O-RAN Telemetry Pipeline"
sidebar_label: "Setup"
sidebar_position: 3
description: "Review the illustrative infrastructure and credentials used in the O-RAN telemetry walkthrough."
keywords: [oran, telecom, telemetry, setup, openshift, edge-processing]
---
...
With prerequisites in place, you're ready to [collect O-RAN metrics](/integrations/oran-telco-pipeline/step-1-collect-oran-metrics.mdx) from your DU nodes.

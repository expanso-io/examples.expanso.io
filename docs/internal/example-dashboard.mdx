...
uniqueTasks: [inspect-legacy-example-dashboard]
claimIds: []
...
- **Minimal (below 50%)**: A single file is present
...
The [Example Health workflow](https://github.com/expanso-io/examples.expanso.io/actions/workflows/example-health.yml) runs:
...
- `src/components/DataPipelineExplorer/types.ts` - TypeScript stage definitions used by the explorer
...
_This dashboard helps maintainers and contributors track example completion and ensure documentation quality._

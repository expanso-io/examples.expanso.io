...
uniqueTasks:
  [inspect-enterprise-migration-db2-to-bigquery-step-6-validate-required-fields]
claimIds: []
...
**Delivery boundary:** Reject invalid records before the BigQuery output; measure storage and query billing separately.
...
You've built all 6 transformation steps! See the complete, complete example configuration:

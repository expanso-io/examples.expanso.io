...
sidebar_position: 3
description: Add authored source and pipeline fields for downstream lineage review.
keywords: [lineage, audit, metadata, tracking]
contentArchetype: step
executionStatus: architecture-only
operationalEvidence: not-assessed
localNavigation: true
uniqueTasks:
  [inspect-enterprise-migration-db2-to-bigquery-step-1-add-lineage-metadata]
claimIds: []
...
**Review context:** Source and pipeline fields can support a separately designed lineage process.
...
<div className="margin-top--lg margin-bottom--lg">
  <a
    href="../step-2-normalize-currency"

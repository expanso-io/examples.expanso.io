...
sidebar_position: 9
description: complete example pipeline combining all 6 transformation steps
...
**Result:** transformed example data in BigQuery with complete lineage.
...
expanso-cli job executions db2-to-bigquery-transactions --state failed --limit 5
...
- [Troubleshooting](/enterprise-migration/db2-to-bigquery/troubleshooting) - Common issues and solutions
- [Cross-Border GDPR](/data-security/cross-border-gdpr) - Add regional data routing
- [Nightly Backup](/enterprise-migration/nightly-backup) - Backup patterns for enterprise data

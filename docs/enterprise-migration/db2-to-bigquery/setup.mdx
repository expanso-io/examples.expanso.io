...
curl -L -o sample-input.json \
  https://raw.githubusercontent.com/expanso-io/examples.expanso.io/main/examples/enterprise-migration/db2-to-bigquery/sample-input.json
...
- [**Step 2: Normalize Currency**](/enterprise-migration/db2-to-bigquery/step-2-normalize-currency)
- [**Step 3: Mask Account Numbers**](/enterprise-migration/db2-to-bigquery/step-3-mask-account-numbers)
- [**Step 4: Categorize Transactions**](/enterprise-migration/db2-to-bigquery/step-4-categorize-transactions)
- [**Step 5: Standardize Schema**](/enterprise-migration/db2-to-bigquery/step-5-standardize-schema)
- [**Step 6: Validate Required Fields**](/enterprise-migration/db2-to-bigquery/step-6-validate-required-fields)

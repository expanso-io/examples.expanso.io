...
This pipeline provides database backup examples:
...
1. [**Setup Guide**](/enterprise-migration/nightly-backup/setup) - Prerequisites and environment
2. [**Step 1: Extract Tables**](/enterprise-migration/nightly-backup/step-1-extract-tables) - Multi-table sequence
3. [**Step 2: Add Metadata**](/enterprise-migration/nightly-backup/step-2-add-metadata) - Backup context
4. [**Step 3: Calculate Checksum**](/enterprise-migration/nightly-backup/step-3-calculate-checksum) - Integrity
5. [**Step 4: Route to Storage**](/enterprise-migration/nightly-backup/step-4-route-to-storage) - Table paths

### Option 2: Jump to Complete Pipeline
Download the complete example configuration:

[**→ Get Complete Pipeline**](/enterprise-migration/nightly-backup/complete-pipeline)

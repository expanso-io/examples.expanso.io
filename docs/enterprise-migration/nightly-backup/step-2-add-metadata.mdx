...
uniqueTasks: [inspect-enterprise-migration-nightly-backup-step-2-add-metadata]
claimIds: []
...
**Review context:** Retain timestamps for a separately designed audit process.
...
<div className="margin-top--lg margin-bottom--lg">
  <a
    href="../step-3-calculate-checksum"

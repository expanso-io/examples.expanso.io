...
uniqueTasks: [review-encrypt-data-troubleshooting]
claimIds: []
...
**Fix:** Store the key version with encrypted data and test the lookup path:
...
**Fix:** Review field selection and measure batching with representative synthetic messages:
...
2. Check the [Complete Pipeline](/data-security/encrypt-data/complete-pipeline) for reference config
3. Review [Encryption Patterns](/data-security/encryption-patterns) for advanced patterns

...
uniqueTasks: [review-encrypt-data-complete-pipeline]
claimIds: []
...
<CodeBlock language="yaml" title="encrypt-data.yaml">
  {pipelineYaml}
</CodeBlock>
...
- [Troubleshooting](/data-security/encrypt-data/troubleshooting) - Common issues and solutions
- [Encryption Patterns](/data-security/encryption-patterns) - Advanced encryption strategies

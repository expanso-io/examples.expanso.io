...
2. Check the [Complete Pipeline](/data-security/remove-pii/complete-pipeline) for reference config
3. Review [Encrypt Data](/data-security/encrypt-data) for encryption instead of deletion

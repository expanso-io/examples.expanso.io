...
:::caution Legal scope
The configuration does not establish GDPR compliance or anonymous-data status. In particular, stable salted hashes are pseudonymous and can remain personal data. Use the output only after privacy and legal review of identifiability, transfer mechanisms, access, retention, and the surrounding system.
:::

...
uniqueTasks: [review-cross-border-gdpr-step-3-delete-high-risk-fields]
claimIds: []
...
Names and addresses have no meaningful aggregate analytics value—you can't sum them or count unique patterns. Delete them.
...
3. Compare against thresholds (years × 365 × 24 × 3600)
...
Track the selected deletions for debugging and review:

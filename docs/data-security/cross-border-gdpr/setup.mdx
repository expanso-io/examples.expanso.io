...
sidebar_label: Setup
sidebar_position: 2
description: Configure EU database connectivity, GCP credentials, and example data-protection settings
keywords: [setup, gdpr, postgres, bigquery, environment, compliance]
---

# Setup Environment for GDPR Pipeline

Before building the cross-border example, configure your EU database connection, GCP destinations, and pseudonymization settings.
...
- **Pseudonymization Salt:** Secret value used for salted hashing
...
This walkthrough assumes an EU/EEA source for illustration. Location alone does not determine compliance, and the transformations in this example do not establish that output is anonymous. Confirm the real source, destination, transfer mechanism, and safeguards with your privacy and legal owners.
:::
...
The example keeps its source archive in an EU region to demonstrate location-aware routing. Your approved storage regions and transfer controls must come from your organization's data-governance policy.
:::
...
# Create sample EU transaction from the tutorial payload below
cat > sample-input.json <<'EOF'
{
  ...
  "customer_address": "Friedrichstraße 123, 10117 Berlin, Germany",
  "customer_postal_code": "10117",
  "transaction_amount_eur": 249.99,
  "merchant_name": "Berlin Electronics GmbH",
  "merchant_category": "electronics",
  "payment_method": "credit_card",
  "card_last_four": "4567",
  "device_ip": "85.214.132.117",
  "country_code": "DE",
  "gdpr_region": "eu-central",
  "transaction_timestamp": "2024-03-15T14:30:45Z"
}
EOF
...
- [**Step 2: Create GDPR Record**](/data-security/cross-border-gdpr/step-2-create-gdpr-record)
- [**Step 3: Delete High-Risk Fields**](/data-security/cross-border-gdpr/step-3-delete-high-risk-fields)
- [**Step 4: Hash Identifiers**](/data-security/cross-border-gdpr/step-4-hash-identifiers)
- [**Step 5: Generalize Values**](/data-security/cross-border-gdpr/step-5-generalize-values)
- [**Step 6: Validate Anonymization**](/data-security/cross-border-gdpr/step-6-validate-anonymization)

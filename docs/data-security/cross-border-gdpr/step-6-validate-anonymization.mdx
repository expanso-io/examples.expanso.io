...
Before output, verify that the direct-identifier fields named by this example were removed or transformed. This is a technical configuration check, not proof that no personal data remains and not a legal compliance gate.

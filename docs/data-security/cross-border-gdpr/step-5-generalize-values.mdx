...
uniqueTasks: [review-cross-border-gdpr-step-5-generalize-values]
claimIds: []
...
- **Timestamp** → Reduce to hour-level precision in this example
...
pipeline:
  processors:
    ...
    - mapping: |
        ...
        # Amount is retained for this example; assess identifiability in context.
...
This is a risk-based decision. Privacy review may require different buckets, field deletion, or a different output entirely.
...
<div className="margin-top--lg margin-bottom--lg">
  <a
    href="../step-6-validate-anonymization"

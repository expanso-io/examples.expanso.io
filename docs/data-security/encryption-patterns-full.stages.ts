...
output:
  stdout: {}`,
    inputLines: [
      ...
      { content: '"card_number": "4532-1234-5678-9010",', indent: 2, key: 'card_number', valueType: 'string' },
      { content: '"cvv": "123",', indent: 2, key: 'cvv', valueType: 'string' },
      { content: '"cardholder_name": "Sarah Johnson"', indent: 2, key: 'cardholder_name', valueType: 'string' },
      { content: '},', indent: 1 },
      { content: '"customer": {', indent: 1 },
      { content: '"email": "sarah.johnson@example.com",', indent: 2, key: 'email', valueType: 'string' },
      { content: '"ssn": "123-45-6789"', indent: 2, key: 'ssn', valueType: 'string' },
      { content: '}', indent: 1 },
      { content: '}', indent: 0 },
    ],
    outputLines: [

...
1.  **Deploy:**
    ```bash
    expanso job deploy production-pipeline-step-4.yaml
    ```

2.  **Test Dropped Log (DEBUG):**
    ```bash
...
👉 [**Step 5: Redact Sensitive Data**](./step-5-redact-sensitive-data)

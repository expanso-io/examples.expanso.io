...
uniqueTasks: [inspect-production-pipeline-setup]
claimIds: []
...
**Next:** [Configure HTTP Input](/log-processing/production-pipeline/step-1-configure-http-input) to build a complete log ingestion example.

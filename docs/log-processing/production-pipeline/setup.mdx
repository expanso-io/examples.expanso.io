...
- **Kafka:** Set up [Kafka](/getting-started/local-development#kafka) for messaging
- **PostgreSQL:** Set up [PostgreSQL](/getting-started/local-development#postgresql) for data persistence
- **Redis:** Set up [Redis](/getting-started/local-development#redis) for caching

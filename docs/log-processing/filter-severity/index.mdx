...
# Filter logs before shipping them
...
[Download filter-logs.yaml](/files/first-results/filter-logs.yaml). The generated input is finite: one batch, then completion.

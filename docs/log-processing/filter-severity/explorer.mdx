...
- [**Step 1: Parse JSON & Add Metadata**](/log-processing/filter-severity/step-1-parse-json-add-metadata) - Extract severity and classify priority
- [**Step 2: Filter by Severity**](/log-processing/filter-severity/step-2-filter-by-severity) - Drop DEBUG/TRACE logs at the edge
- [**Advanced Filtering and Routing**](/log-processing/filter-severity/step-4-advanced-patterns) - Combine filters with fan-out and failover patterns

---

**Next:** [Set up your environment](/log-processing/filter-severity/setup) to build log filtering pipelines yourself

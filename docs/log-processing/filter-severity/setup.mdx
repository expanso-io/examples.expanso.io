...
uniqueTasks: [inspect-filter-severity-setup]
claimIds: []
...
**Continue to:** [Step 1: Parse JSON & Add Metadata](/log-processing/filter-severity/step-1-parse-json-add-metadata) to start building the filtering functionality.

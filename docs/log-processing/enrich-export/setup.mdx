...
- **Kafka:** Set up [Kafka](/getting-started/local-development#kafka) for enriched log delivery
...
- **AWS CLI:** Installed for S3 access ([Installation Guide](https://docs.aws.amazon.com/cli/latest/userguide/install-cliv2.html))

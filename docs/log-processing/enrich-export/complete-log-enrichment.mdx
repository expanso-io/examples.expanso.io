...
uniqueTasks: [inspect-enrich-export-complete-log-enrichment]
claimIds: []
...
<CodeBlock language="yaml" title="enrich-export.yaml">
  {pipelineYaml}
</CodeBlock>
...
- [Troubleshooting](/log-processing/enrich-export/troubleshooting) - Common issues and solutions
- [Filter Severity](/log-processing/filter-severity) - Route logs by severity level

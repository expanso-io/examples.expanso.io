...
uniqueTasks: [inspect-enrich-export-step-5-export-s3]
claimIds: []
...
The final step of this tutorial sends your enriched, restructured, and batched logs to **Amazon S3**.
...
You have now built the complete tutorial pipeline: it generates data, adds lineage, restructures it, and exports it to cloud storage.
